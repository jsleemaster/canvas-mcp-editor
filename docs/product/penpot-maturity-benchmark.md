...
2. Full comment workflow beyond selected-node create/list/resolve, full visual diff, branch/review/merge, pinned/version preview controls, retention controls, and richer recovery workflow beyond the landed manual/automatic saved file versions, basic diff preview, and restore path.
