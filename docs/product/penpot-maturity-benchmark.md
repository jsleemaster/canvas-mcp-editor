...
| Import/export | Penpot file import/export, backups, shared libraries, assets. | Local design JSON, asset storage, image paste/drop, code export, and document-local DTCG color-token import/export. | Open project export/import, Penpot/Figma migration paths, asset packaging, and backup/restore. |
...
3. Design-system maturity beyond first-class color tokens, fill bindings, and DTCG color-token import/export: token sets/modes, typography/spacing tokens, reusable styles, variants, shared libraries, and code component mappings.
