...
cleanup, Rust round-trip, and CSS-variable code export fallback. Remaining
design-system gaps are multi-effect stacks, reusable effect styles, richer
raster/vector effect fidelity, and hosted theme/library registry sync.
