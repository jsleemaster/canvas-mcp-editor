...
CSS/structure code-export metadata. Remaining design-system gaps are
multi-effect stacks, richer raster/vector effect fidelity, and hosted
theme/library registry sync.
