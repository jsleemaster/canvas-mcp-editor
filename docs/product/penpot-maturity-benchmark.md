...
2. Comments, automatic edit history, visual diff, branch/review/merge, and richer recovery workflow beyond the landed manual saved file versions and restore path.
