...
| Developer handoff | Inspect, HTML/CSS/SVG access, API, webhooks, plugin integrations. | MCP/HTTP inspect, validate, change summary, structured code export, and a visible Inspector Dev tab that shows selected-layer geometry, fill, generated CSS, generated HTML, exported structure, copy controls for CSS/HTML/structure snippets, selected-layer SVG/PNG/JPEG downloads, and selected-layer PNG/JPEG 1x/2x/3x scale options. Complex nested/image SVG/PNG/JPEG fidelity, WEBP/PDF exports, persistent multi-export presets, richer ready-for-dev annotations, webhooks, and repo component mappings remain immature. | Visible Dev panel plus MCP/API surfaces, repo component mappings, and ready-for-dev annotations. |
...
4. Developer handoff beyond the visible Inspector Dev tab backed by existing HTTP code export data, CSS/HTML/structure copy controls, selected-layer SVG/PNG/JPEG downloads, and selected-layer PNG/JPEG scale options: complex nested/image SVG/PNG/JPEG fidelity, WEBP/PDF exports, persistent multi-export presets, richer annotations, webhook/API integration stories, and repo component mappings.
