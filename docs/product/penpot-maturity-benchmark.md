...
| Developer handoff | Inspect, HTML/CSS/SVG access, API, webhooks, plugin integrations. | MCP/HTTP inspect, validate, change summary, structured code export, and a visible Inspector Dev tab that shows selected-layer geometry, fill, generated CSS, generated HTML, exported structure, copy controls for CSS/HTML/structure snippets, and selected-layer SVG and PNG downloads. Complex nested/image SVG/PNG fidelity, multi-format export presets, asset scale options, richer ready-for-dev annotations, webhooks, and repo component mappings remain immature. | Visible Dev panel plus MCP/API surfaces, repo component mappings, and ready-for-dev annotations. |
...
4. Developer handoff beyond the visible Inspector Dev tab backed by existing HTTP code export data, CSS/HTML/structure copy controls, and selected-layer SVG/PNG downloads: complex nested/image SVG/PNG fidelity, multi-format export presets, asset scale options, richer annotations, webhook/API integration stories, and repo component mappings.
