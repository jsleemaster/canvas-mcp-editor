...
2. Full comment workflow beyond selected-node create/list/resolve/reply and viewport unresolved-comment bubbles: mentions, unread notifications, live comment sync, dashboard/activity notifications, full visual diff, branch/review/merge, pinned/version preview controls, retention controls, and richer recovery workflow beyond the landed manual/automatic saved file versions, basic diff preview, and restore path.
