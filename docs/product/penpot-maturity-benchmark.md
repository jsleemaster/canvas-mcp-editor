...
1. Complete Penpot-like layout maturity beyond the landed Flex alignment, child-margin, static/absolute layout-item, wrap, row/column gap, and container fit sizing slices: grid-like layout behavior, child fill sizing, min/max rules, baseline alignment, and deeper resizing semantics.
