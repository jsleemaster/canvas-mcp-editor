...
5. Full import/export workflow beyond the landed single-file Layo ZIP archive
   and file-panel review UI: multi-file project archives, shared library
   packaging, backup/restore runbooks, and Penpot/Figma migration paths where
   feasible.
