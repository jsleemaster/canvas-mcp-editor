...
source switches, Rust round-trip, and CSS/structure code handoff. Remaining
design-system gaps are richer multi-effect/style-token fidelity and hosted
