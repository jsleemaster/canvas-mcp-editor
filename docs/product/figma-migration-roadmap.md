...
- Local image asset storage with browser clipboard paste, file drag/drop insertion for image nodes, original image dimensions, and context-menu original-size restore.
