...
- Wrap, gap, padding, child item margins, static/absolute layout item positioning, and wrapped-line distribution.
...
- Add inspector controls for layout mode, flow, wrap, alignment, distribution, gap, padding, child margins, child layout-item positioning, and constraints.
- Add Playwright coverage for automatic sibling repositioning and parent resize behavior.

Non-goals for the first slice:

- Grid auto layout.
- Row/column gap split, min/max, baseline alignment, and advanced sizing rules.
...
1. Keep the landed Lane 1 layout foundation, Flex alignment, child-margin flow, static/absolute layout item positioning, wrap, and PR #20 navigation fixes green.
